...
import (
	...
	"github.com/notherealmarco/WhaleDeployer/service/api"
	"github.com/notherealmarco/WhaleDeployer/service/database"
	"github.com/notherealmarco/WhaleDeployer/service/globaltime"
...
func run() error {
	...
	if err := os.MkdirAll(cfg.Data.KeysPath, 0755); err != nil {
